...
public class ChatterbookController {
    ...
    @RequestMapping(value = "/chatterbooks/users", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/chatterbooks/users/{name}", method = RequestMethod.GET)
    ...
    // Gets the posts by name
    @RequestMapping(value = "/chatterbooks/posts/{name}", method = RequestMethod.GET)
